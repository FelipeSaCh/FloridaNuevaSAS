...
*   **`Python_scripts/`**: Contiene scripts en Python utilizados principalmente para el procesamiento de datos, comparación de libros, extracción de notas y conversión de archivos (Excel, CSV).
